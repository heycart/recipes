...

{
  ...
  services.mysql = {
    ...
    initialDatabases = lib.mkDefault [{ name = "heycart"; }];
    ensureUsers = lib.mkDefault [
      {
        name = "heycart";
        password = "heycart";
        ensurePermissions = {
          "heycart.*" = "ALL PRIVILEGES";
          "heycart_test.*" = "ALL PRIVILEGES";
        };
      }
    ];
    settings = {
  ...
  env.DATABASE_URL = lib.mkDefault "mysql://heycart:heycart@127.0.0.1:3306/heycart";

  # HeyCart 6 related scripts
